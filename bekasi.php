...
<html>
	...
	<?php
	$json_string1 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/conditions/q/IA/Bekasi.json");
	$json_string2 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/astronomy/q/IA/Bekasi.json");
	$json_string3 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/forecast/q/IA/Bekasi.json");
